                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table class="table table-striped jambo_table bulk_action" id="datatable">
                                <thead>
                                    <tr>
                                        <th class="text-center" style="font-size: 17px;">Kode</th>
                                        <th class="text-center" style="font-size: 17px;">Nama</th>
                                        <th class="text-center" style="font-size: 17px;">Harga Beli</th>
                                        <th class="text-center" style="font-size: 17px;">Harga Jual</th>
